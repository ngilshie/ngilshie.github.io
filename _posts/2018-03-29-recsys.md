...
<figure>
	...
	<img src = "\assets\LSTM_architecture.png" height = "400" width = "700" align = "middle">
</figure>
...
Figure 11 below plots the accuracies on the training and validation sets, computed at every 15th iteration. (to be continued).
...
> Co-attending Free-form Regions and Detections with Multi-modal Multiplicative Feature Embedding for Visual Question Answering (1711.06794)

<center>Listing 5: 10 nearest neighbors for Experiment 2</center>
```
1. Image2song: Song Retrieval via Bridging Image Content and Lyric Words (1708.05851)
2. Evidence Aggregation for Answer Re-Ranking in Open-Domain Question Answering (1711.05116)
3. Unsupervised Part-based Weighting Aggregation of Deep Convolutional Features for Image Retrieval (1705.01247)
4. Assertion-based QA with Question-Aware Open Information Extraction (1801.07414)
5. Cross-Media Similarity Evaluation for Web Image Retrieval in the Wild (1709.01305)
6. TGIF-QA: Toward Spatio-Temporal Reasoning in Visual Question Answering (1704.04497)
7. Speech-Based Visual Question Answering (1705.00464)
8. Structured Triplet Learning with POS-tag Guided Attention for Visual Question Answering (1801.07853)
9. DVQA: Understanding Data Visualizations via Question Answering (1801.08163)
10. S-Net: From Answer Extraction to Answer Generation for Machine Reading Comprehension (1706.04815)
```
